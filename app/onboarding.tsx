...
export default function OnboardingScreen() {
  ...
  const renderStep1SelectLanguage = () => {
    return (
      <View style={styles.stepContainer}>
        <ThemedText type="title" style={styles.title}>
        ...
        <ThemedText style={styles.subtitle}>
          Pick one language to personalize your lessons.
        </ThemedText>
  ...
  const renderStep2Level = () => (
    <View style={styles.stepContainer}>
      <ThemedText type="title" style={styles.title}>
        How much {selectedLanguageLabel} do you know?
      </ThemedText>
  ...
  const renderStep3Motivation = () => (
    <View style={styles.stepContainer}>
      <ThemedText type="title" style={styles.title}>
        Why are you learning {selectedLanguageLabel}?
      </ThemedText>
      ...
      >
        ...
        <View style={styles.mainContent}>
          ...
          >
            ...
            {step === 1 && renderStep1SelectLanguage()}
            {step === 2 && renderStep2Level()}
            {step === 3 && renderStep3Motivation()}
            {step === 4 && renderStep4Interests()}
          </Animated.View>
        </View>
